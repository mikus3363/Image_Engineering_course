...
scene = Scene(
    objects=[
        Sphere(position=np.array([-1.5, -1, 0]), radius=0.5, diffuse=np.array([0.2, 1.0, 0.3]), transparency=0.5, refraction_index=1.3),  # półprzezroczysta kula
        Sphere(position=np.array([0, 0, 0]), radius=1.0, diffuse=np.array([0.1, 0.3, 0.8]), transparency=0.6, refraction_index=1.5),  # przezroczysta kula
        Triangle(np.array([1.5, -0.5, -1]), np.array([2.5, -0.5, -1]), np.array([2.0, 0.5, -1]), diffuse=np.array([1.0, 0.7, 0.2]))  # dodatkowy trójkąt *
    ],
